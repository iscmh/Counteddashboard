            ...
            <div className="flex-1 overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <div className="bg-gradient-to-br from-white to-indigo-50/30 rounded-xl p-4 shadow-sm border border-indigo-100/50 hover:shadow-md transition-all duration-300">
                  ...
                  <p className="text-lg sm:text-2xl font-bold mt-2">${stats.monthlyRecurringRevenue.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-white to-indigo-50/30 rounded-xl p-4 shadow-sm border border-indigo-100/50 hover:shadow-md transition-all duration-300">
                  ...
                  <p className="text-lg sm:text-2xl font-bold mt-2">${stats.totalEarnings.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
